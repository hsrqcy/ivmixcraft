...
recipes.addShaped(<artisanworktables:design_pattern>.withTag({}) * 4, [
	[null, <ftgumod:parchment_empty>, null],
    [<ftgumod:parchment_empty>, <ore:artisansQuill>, <ftgumod:parchment_empty>],
    [null, <ftgumod:parchment_empty>, null]
]);

recipes.addShaped(<artisanworktables:worktable:12>, [
	[null, <artisanworktables:design_pattern>.withTag({}), null],
    [<ftgumod:parchment_empty>, <magneticraft:light_plates:6>, <ftgumod:parchment_empty>],
    [<minecraft:crafting_table>, <minecraft:crafting_table>, <minecraft:crafting_table>]
]);

recipes.addShaped(<artisanworktables:workstation:12>, [
    ...
    [<magneticraft:light_plates:6>, <artisanworktables:worktable:12>, <magneticraft:light_plates:6>],
    [<magneticraft:light_plates:6>, <magneticraft:light_plates:6>, <magneticraft:light_plates:6>]
]);

recipes.addShaped(<artisanworktables:workshop:12>, [
	 [<artisanworktables:design_pattern>.withTag({}), <artisanworktables:design_pattern>.withTag({}), <artisanworktables:design_pattern>.withTag({})],
    [<ore:heavyPlateSteel>, <artisanworktables:workstation:12>, <ore:heavyPlateSteel>],
    [<ore:heavyPlateSteel>, <ore:heavyPlateSteel>, <ore:heavyPlateSteel>]
]);
...
RecipeBuilder.get("designer")
  .setShaped([
    ...
    [<ore:lightPlateSteel>, <magneticraft:crafting:1>, <ore:lightPlateSteel>],
    [<magneticraft:crafting:2>, <skyresources:casing:4>, <magneticraft:crafting:2>]])
  .addTool(<ore:artisansQuill>, 30)
  .setExtraOutputOne(<magneticraft:crafting:2>, 0.15)
  .setExtraOutputTwo(<thermalfoundation:material:32>, 0.25)
  .setExtraOutputThree(<minecraft:iron_block>, 0.15)
  .setLevelRequired(8)
  .setConsumeExperience(true)
  .addRequirement(FTGU.allOf(["IvMixCraft:origin/blacksmith", "IvMixCraft:Industry/designer"]))
  .setFluid(<liquid:lava> * 2000)
...
RecipeBuilder.get("designer")
  .setShaped([
    [<ore:lightPlateSteel>, <ore:lightPlateSteel>, <ore:lightPlateSteel>],
    [<ore:lightPlateSteel>, <magneticraft:electric_piston>.withTag({}), <ore:lightPlateSteel>],
    [<magneticraft:crafting:2>, <skyresources:casing:4>, <magneticraft:crafting:2>]])
  ...
  .setShaped([
    [<ore:lightPlateSteel>, <ore:lightPlateSteel>, <ore:lightPlateSteel>],
    [<ore:lightPlateSteel>, <magneticraft:electric_piston>.withTag({}), <ore:lightPlateSteel>],
    [<magneticraft:crafting:2>, <ore:chest>, <magneticraft:crafting:2>]])
